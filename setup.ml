...
(* OASIS_START *)
(* DO NOT EDIT (digest: c6291e58afc89d070813c17a1c6e577f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.3";
          ocaml_version = Some (OASISVersion.VGreaterEqual "3.11.2");
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("expect.pcre",
                               Some (OASISVersion.VGreaterEqual "0.0.4"));
                           InternalLibrary "oasis";
                           InternalLibrary "base";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\215\183\001JQ\b\150\004\209\192\168\213\235K6?";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
